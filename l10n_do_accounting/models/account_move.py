...
class AccountMove(models.Model):
    ...
    l10n_do_sequence_prefix = fields.Char(compute="_compute_split_sequence", store=False)
    l10n_do_sequence_number = fields.Integer(
        compute="_compute_split_sequence", store=False
    )
    ...
    l10n_latam_manual_document_number = fields.Boolean(store=False)
